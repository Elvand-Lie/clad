...
/// so callers may keep using it after the handle goes away. Move-only.
...
public:
  ...
  ClonedFunction(ClonedFunction&& other) noexcept;
  ClonedFunction& operator=(ClonedFunction&& other) noexcept;
  ~ClonedFunction();
};
